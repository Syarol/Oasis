...
document.addEventListener('DOMContentLoaded', () => {
	...
	ServerInteract.getSpecialMarked('RECOMMEND', document.getElementsByClassName('cr-recommends-section')[0], Render.carouselItems, cart)
		.getSpecialMarked('BESTSELLERS', document.getElementsByClassName('cr-bestsellers-section')[0], Render.carouselItems, cart)
		.getSpecialMarked('ARRIVALS', document.getElementsByClassName('cr-arrivals-section')[0], Render.carouselItems, cart);
